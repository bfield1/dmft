...
def dos_from_band(dispersion, nk, dims=2, bins=None, de=None):
    """
    ...
    Inputs:
        dispersion - f(kx, ky,...) -> float. Band dispersion, takes numpy
